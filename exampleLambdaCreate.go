...
func main() {
	zipFilePtr := flag.String("z", "./test.py", "The name of the ZIP file (without the .zip extension)")
	bucketPtr := flag.String("b", "my-bucket-56f4e73", "the name of bucket to which the ZIP file is uploaded")
	functionPtr := flag.String("f", "goLangLambda", "The name of the Lambda function")
	handlerPtr := flag.String("h", "lambda_function.lambda_handler", "The name of the package.class handling the call")
	resourcePtr := flag.String("a", "arn:aws:iam::932446063073:role/service-role/executeSlackLambda", "The ARN of the role that calls the function")
	runtimePtr := flag.String("r", "python3.6", "The runtime for the function.")
